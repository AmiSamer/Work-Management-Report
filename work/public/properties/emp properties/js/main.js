...
(function ($) {
  ...
  var Porto = {
    ...
    init: function () {
      ...
      /* Call function if noUiSlider plugin is included - for product category pages */
    ...
    owlCarousels: function () {
      ...
      $('.boxed-slider').on('loaded.owl.lazy', function (event) {
        $(event.element).closest('.product category-slide').addClass('loaded');
      });
    ...
    filterSlider: function () {
      // Slider For product category pages / filter price
    ...
    ajaxLoadProduct: function () {
      ...
      $loadButton.click(function (e) {
        ...
        $(this).text('Loading ...');
        $.ajax({
          url: "ajax/product category-ajax-products.html",
